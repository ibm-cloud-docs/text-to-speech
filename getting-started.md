...
1.  Go to the [{{site.data.keyword.texttospeechshort}} service](https://console.bluemix.net/catalog/services/text-to-speech/){: new_window} and either sign up for a free Bluemix account or log in.
