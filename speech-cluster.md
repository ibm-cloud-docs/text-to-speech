...
Checking this option also removes sensitive information from container logs. For information about anonymizing data, see [Anonymizing logs and audio data](/docs/text-to-speech?topic=text-to-speech-speech-override#speech-override-anonymize).
