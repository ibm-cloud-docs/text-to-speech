...
For information about releases and updates for {{site.data.keyword.texttospeechshort}} for {{site.data.keyword.cloud_notm}}, see [Release notes for {{site.data.keyword.cloud_notm}}](/docs/text-to-speech?topic=text-to-speech-release-notes).
{: note}
...
### New enhanced neural voices
{: #v40-enhanced-neural-voices}
...
-   **9 April:** The service lets you add or remove installed models or voices for version 1.2 or 1.2.1 of the Speech services. For more information, see [Modifying the installed models and voices](/docs/text-to-speech?topic=text-to-speech-speech-cluster-12#speech-cluster-models-voices-12).
...
-   The service now supports five new neural voices:
    ...
    These new voices have the same capabilities for customization and SSML as all existing voices. For more information, see [Supported languages and voices](/docs/text-to-speech?topic=text-to-speech-voices#languageVoices).
...
-   The service now offers the neural Japanese voice `ja-JP_EmiV3Voice`. For more information, see [Supported languages and voices](/docs/text-to-speech?topic=text-to-speech-voices#languageVoices).
