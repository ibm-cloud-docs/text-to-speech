...
| Dutch<br/>(Belgian) | Female<br/>Neural | `nl-BE_AdeleVoice` | <audio controls style="width:250px;height:30px"><source src="https://watson-developer-cloud.github.io/doc-tutorial-downloads/text-to-speech/samples-neural/Adele.wav" type="audio/wav"></audio> |
