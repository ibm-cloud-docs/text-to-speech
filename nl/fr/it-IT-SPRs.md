...
Si aucun allophone n'est utilisé dans SPR, le service {{site.data.keyword.texttospeechshort}} génère automatiquement la variante appropriée pour le contexte donné.
