...
以下の各セクションにブラジル・ポルトガル語の有効な記号をまとめます。

## 通常母音
{: #ptRegularVowels}

<table style="width:90%">
  <caption>表 1. 通常母音 (ブラジル・ポルトガル語)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      ブラジル・ポルトガル語<br/>SPR 記号
    </th>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      IPA の記号
    </th>
...
<table style="width:90%">
  <caption>表 2. 半母音 (ブラジル・ポルトガル語)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      ブラジル・ポルトガル語<br/>SPR 記号
    </th>
...
<table style="width:90%">
  <caption>表 3. 子音 (ブラジル・ポルトガル語)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      ブラジル・ポルトガル語<br/>SPR 記号
    </th>
