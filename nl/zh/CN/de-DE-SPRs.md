...
<table style="width:90%">
  ...
  <tr>
    ...
    <td>
      B<u>&uuml;</u>cher、f<u>&uuml;h</u>len、T<u>&uuml;</u>r、k<u>&uuml;</u>hn
    </td>
  </tr>
  <tr>
    <td style="text-align:center">
...
<table style="width:90%">
  ...
  <tr>
    ...
    <td>
      <u>K</u>atze、E<u>ck</u>e、S<u>k</u>ulptur、la<u>g</u>、<u>q</u>uitt
    </td>
  </tr>
  <tr>
    <td style="text-align:center">
...
1.  IPA 音标符号 <code>&#240;</code> (IPA Unicode `00F0`) 仅在来自其他语言的外来词中出现，主要源自英语（例如，*The New York Times*）。但是，服务会将该发音实现为 IPA 音标符号 `d` (IPA Unicode `0064`)。
1.  IPA 音标符号 <code>&#952;</code> (IPA Unicode `03B8`) 仅在来自其他语言的外来词中出现，主要源自英语（例如，*thriller*）。但是，服务会将该发音实现为 IPA 音标符号 <code>&#678;</code> (IPA Unicode `02A6`)。
