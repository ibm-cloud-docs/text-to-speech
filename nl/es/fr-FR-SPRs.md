...
# Símbolos para el francés
{: #frSymbols}

En las secciones siguientes se describen los símbolos válidos para el francés.

## Vocales
{: #frVowels}

<table style="width:90%">
  <caption>Tabla 1. Vocales (francés)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Francés<br/>Símbolo SPR
    </th>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Símbolo IPA
    </th>
...
<table style="width:90%">
  <caption>Tabla 2. Consonantes (francés)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Francés<br/>Símbolo SPR
    </th>
...
En francés, se puede utilizar `_` (guión bajo) después de una consonante a final de palabra (pero dentro de las comillas dobles que encierran el SPR) para indicar que es una consonante de enlace. Una consonante de enlace solo se pronuncia si la siguiente palabra empieza por vocal.

<table style="width:54%">
  <caption>Tabla 3. Liaison (francés)</caption>
  <tr>
