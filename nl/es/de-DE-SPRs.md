...
En las secciones siguientes se describen los símbolos válidos para el alemán.

## Vocales regulares
{: #deRegularVowels}

<table style="width:90%">
  <caption>Tabla 1. Vocales regulares (alemán)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Alemán<br/>Símbolo SPR
    </th>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Símbolo IPA
    </th>
...
<table style="width:90%">
  <caption>Tabla 2. Vocales reducidas (alemán)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Alemán<br/>Símbolo SPR
    </th>
...
<table style="width:90%">
  <caption>Tabla 3. Diptongos (alemán)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Alemán<br/>Símbolo SPR
    </th>
...
Las vocales nasales, en francés, aparecen mayoritariamente en extranjerismos.

<table style="width:90%">
  <caption>Tabla 4. Vocales nasales (alemán)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Alemán<br/>Símbolo SPR
    </th>
...
<table style="width:90%">
  <caption>Tabla 5. Consonantes (alemán)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Alemán<br/>Símbolo SPR
    </th>
...
1.  El símbolo IPA <code>&#240;</code> (IPA Unicode `00F0`) solo aparece en extranjerismos. mayoritariamente del inglés (por ejemplo, *The New York Times*). Sin embargo, el servicio realiza ese sonido como el símbolo IPA `d` (IPA Unicode `0064`).
1.  El símbolo IPA <code>&#952;</code> (IPA Unicode `03B8`) solo aparece en extranjerismos. mayoritariamente del inglés (por ejemplo, *thriller*). Sin embargo, el servicio realiza ese sonido como el símbolo IPA <code>&#678;</code> (IPA Unicode `02A6`).
