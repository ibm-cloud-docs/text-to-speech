...
# Símbolos para el italiano
{: #itSymbols}

En las secciones siguientes se describen los símbolos válidos para el italiano.

## Vocales regulares
{: #itRegularVowels}

<table style="width:90%">
  <caption>Tabla 1. Vocales regulares (italiano)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Italiano<br/>Símbolo SPR
    </th>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Símbolo IPA
    </th>
...
<table style="width:90%">
  <caption>Tabla 2. Consonantes (italiano)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Italiano<br/>Símbolo SPR
    </th>
...
<table style="width:90%">
  <caption>Tabla 3. Geminadas (italiano)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Italiano<br/>Símbolo SPR
    </th>
...
Si un alófono no se utiliza en SPR, el servicio {{site.data.keyword.texttospeechshort}} genera automáticamente la variante adecuada para el contexto dado.

<table style="width:90%">
  <caption>Tabla 4. Alófonos (italiano)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Alófono italiano<br/>Símbolo SPR
    </th>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Símbolo IPA
    </th>
