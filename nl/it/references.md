...
Per ulteriori informazioni sulla ricerca che c'è dietro il servizio {{site.data.keyword.texttospeechdatafull}} for {{site.data.keyword.icp4dfull}}, vedi i seguenti documenti. I ricercatori IBM hanno scritto o contribuito a tutti questi documenti.
{: shortdesc}
...
1.  <a id="kons2019" style="border-bottom:none">Kons, Zvi, Slava Shechtman, Alex Sorin, Carmel Rabinovitz e Ron Hoory.</a> [*High quality, lightweight and adaptable TTS using LPCNet.*](https://arxiv.org/abs/1905.00590){: external} Presentato a Interspeech (2019). 
