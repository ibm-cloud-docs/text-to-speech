...
# Simboli per l'italiano
{: #itSymbols}

Le seguenti sezioni descrivono i simboli validi per l'italiano.
...
Se un allofono non è utilizzato in SPR, il servizio {{site.data.keyword.texttospeechshort}} genera automaticamente la variante appropriata per il contesto indicato.

<table style="width:90%">
  <caption>Tabella 4. Allofoni (italiano)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Simbolo SPR<br/>per l'allofono italiano
    </th>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Simbolo IPA
    </th>
