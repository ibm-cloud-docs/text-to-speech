...
# Simboli per il tedesco
{: #deSymbols}

Le seguenti sezioni descrivono i simboli validi per il tedesco.
...
Le vocali nasali in francese si trovano per lo più nei prestiti linguistici.
...
1.  Il simbolo IPA <code>&#240;</code> (Unicode IPA `00F0`) ricorre solo nei prestiti linguistici da lingue straniere, principalmente dall'inglese (ad esempio, *The New York Times*). Tuttavia, il servizio riconosce che il suono è il simbolo IPA `d` (Unicode IPA `0064`).
1.  Il simbolo IPA <code>&#952;</code> (Unicode IPA `03B8`) ricorre solo nei prestiti linguistici da lingue straniere, principalmente dall'inglese (ad esempio, *thriller*). Tuttavia, il servizio riconosce che il suono è il simbolo IPA <code>&#678;</code> (Unicode IPA `02A6`).
