...
# Simboli per il portoghese brasiliano
{: #ptSymbols}

Le seguenti sezioni descrivono i simboli validi per il portoghese brasiliano.
...
1.  Il simbolo SPR `a` è associato a due diversi simboli IPA con pronunce diverse: `a` e <code>&#592;</code>. In generale, il simbolo SPR è associato ad `a` per la sintesi di sillabe accentate e a <code>&#592;</code> per la sintesi di sillabe non accentate.
