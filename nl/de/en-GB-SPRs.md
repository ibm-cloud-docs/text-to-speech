...
# Symbole für britisches Englisch
{: #gbSymbols}

In den folgenden Abschnitten sind die gültigen Symbole für britisches Englisch beschrieben.

## Normale Vokale
{: #gbRegularVowels}

<table style="width:90%">
  <caption>Tabelle 1. Normale Vokale (britisches Englisch)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Symbol in SPR für<br/>britisches Englisch
    </th>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Symbol in IPA
    </th>
...
<table style="width:90%">
  <caption>Tabelle 2. Diphthonge (britisches Englisch)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Symbol in SPR für<br/>britisches Englisch
    </th>
...
<table style="width:90%">
  <caption>Tabelle 3. Reduzierte Vokale (britisches Englisch)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Symbol in SPR für<br/>britisches Englisch
    </th>
...
<table style="width:90%">
  <caption>Tabelle 4. Konsonanten (britisches Englisch)</caption>
  <tr>
    <th style="width:20%; text-align:center; vertical-align:bottom">
      Symbol in SPR für<br/>britisches Englisch
    </th>
